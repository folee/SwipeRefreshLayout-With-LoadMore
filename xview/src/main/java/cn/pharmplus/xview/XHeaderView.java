...
/**
 * The header view for {@link XListView} and {@link XScrollView}
 * 
 */
public class XHeaderView extends LinearLayout {
	...
	private void initView(Context context) {
		...
		/*anim_arrow = (AnimationDrawable) mArrowImageView.getDrawable();
		iv_loading = (ImageView) findViewById(R.id.iv_loading);
		anim_iv_loading = (AnimationDrawable) iv_loading.getDrawable();*/
	...
	public void setState(int state) {
		...
		case STATE_REFRESHING:
			...
			break;
		case STATE_DONE:
			mHintTextView.setText(R.string.load_completed);
			break;
	...
	public int getVisibleHeight() {
		return mContainer.getLayoutParams().height;//getHeight();
	}
