...
/**
 * The footer view for {@link XListView} and {@link XScrollView}
 * 
 */
@SuppressLint("NewApi")
public class XFooterView extends LinearLayout {
	...
	private void initView(Context context) {
		...
		footer_rl = mLayout.findViewById(R.id.footer_rl);
		footer_ll = mLayout.findViewById(R.id.footer_ll);
	...
	public void setState(int state) {
		if (state == mState /*|| mState == STATE_NO_MORE*/)
			return;
		...
		if (state == STATE_LOADING) {
			...
			footer_ll.setVisibility(View.INVISIBLE);
		}
		...
		case STATE_READY:
			...
			break;
		case STATE_NO_MORE:
			mHintView.setText(R.string.footer_no_more_data);
			break;
		case STATE_LOADING:
			break;
		}
	...
	/**
	 * Set the footer view visible height.
	 *
	 * @param height
	 */
	...
	/**
	 * Get the footer view visible height.
	 *
	 * @return
	 */
	 ...
	 */
	public void hide() {
		int mFooterHeight = this.getHeight();
		DebugLog.w("----> mFooterHeight = " + mFooterHeight);
		LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) mLayout.getLayoutParams();
		lp.height = 0;
		mLayout.setLayoutParams(lp);
		footer_rl.setVisibility(View.INVISIBLE);

		//this.animate().translationY(mFooterHeight).setDuration(200);
	}
